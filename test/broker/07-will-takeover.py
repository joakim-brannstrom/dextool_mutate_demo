...
def do_test(proto_ver, clean_session):
    ...
    connect2_packet = mosq_test.gen_connect("will-test", keepalive=keepalive, proto_ver=proto_ver, will_topic="will/test", will_payload=b"will delay", clean_session=clean_session)
    ...
    try:
        ...
        sock3 = mosq_test.do_client_connect(connect2_packet, connack2b_packet, timeout=30, port=port)
